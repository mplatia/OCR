...
img=cv2.imread(r'Imagenes/PliegoMitad1.jpg',1) # Leer imagen
...
ret, thresh = cv2.threshold(ditalacion,  220, 255, cv2.THRESH_BINARY_INV)
...
black1 = cv2.rectangle(black,(0, 0), (6600, 600),(255, 255, 255), -1)   #--- ROI Horizontal
...
for a, b in enumerate(boxes1.splitlines()):
    ...
    for l in range(1, 16):
        ...
        # if len(b) == 12:
            ...
            cv2.rectangle(img, (x - 380, y + 280), (x + w + 340, y + h - 50), (0, 0, 0), 5)
            #cv2.rectangle(img, (x - 270, y + 180), (x + w + 245, y + h - 50), (0, 0, 0), 5)
            yy = dy * l
            cv2.rectangle(img, (x - 380, y + 280 + yy), (x + w + 340, y + h - 50 +yy), (0, 0, 0), 5)
...
imgResizei = cv2.resize(img , (1200, 600))
cv2.imshow("w", imgResizei)

# imgResizeifb = cv2.resize(fin , (1200, 600))
